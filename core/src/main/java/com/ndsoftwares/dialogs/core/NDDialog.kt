...
import com.ndsoftwares.dialogs.core.databinding.NdDialogBaseBinding
 ...
 */
typealias AddOnComponent = NDDialog.() -> Unit

/** Listener that is invoked when the view was created. */
typealias OnViewCreatedListener = (NdDialogBaseBinding) -> Unit
 ...
 */
abstract class NDDialog : NDDialogFragment() {
    ...
    private lateinit var base: NdDialogBaseBinding
    ...
    override fun onCreateView(
        ...
        return NdDialogBaseBinding.inflate(LayoutInflater.from(activity), container, false)
            .also { base = it }.apply {
    ...
    private fun setupBottomSheet() {
        ...
        val isCloseButtonVisible = dialogStyle == DialogStyle.BOTTOM_SHEET &&
